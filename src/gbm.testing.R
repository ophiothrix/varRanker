...
model_gbm <- h2o.gbm(x = features, y = target, training_frame = train.set.h2o, distribution = "bernoulli", ntrees = 10, max_depth = 5, min_rows = 2, learn_rate = 0.2, nfolds = nfolds, fold_assignment = "Modulo", keep_cross_validation_predictions = TRUE, seed = 16052017)
summary(model_gbm)
