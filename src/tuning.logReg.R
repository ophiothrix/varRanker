...
model_lreg <- h2o.glm(x = features, y = target, training_frame = train.set.h2o, model_id = "h2o_lreg", family = "binomial", nfolds = 5, link = "logit", keep_cross_validation_predictions = T, seed = 16052017, validation_frame = valid.set.h2o)
