...
# ## Remove CADD score
# training.set <- training.set[-grep("cadd", colnames(training.set))]
## Make a set without DNAse features
no.dnase.training.set <- training.set[,-grep("DNase", colnames(training.set))]
