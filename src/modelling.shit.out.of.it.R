...
training.set <- prepare.training.set(path.to.positive.set = "./cache/cadd.annotated.variants/E126.annotated.fSkin_fibro.variants.rds", path.to.negative.set = "./cache/cadd.annotated.variants/E126.annotated.fSkin_fibro.negative.set.rds", prop.matched = 0.4, prop.dnase = 0.6, prop.random = 0.05)
